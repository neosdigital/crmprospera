...
import { LayoutDashboard, Users2, RefreshCw, BarChart3, Plug, Settings, Radio, ListChecks, Bell, Kanban } from "lucide-react";
...
const ITEMS = [
  ...
  { href: "/kanban", label: "Kanban", icon: <Kanban size={ICON_SIZE} /> },
